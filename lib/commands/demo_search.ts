...
/**
 * Demo-board command: the fixture search the Phase-1 live board renders.
 * Superseded for real searches by create_search.ts (3.1); kept for the
 * simulated-data demo path.
 *
